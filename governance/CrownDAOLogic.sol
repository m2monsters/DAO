...
contract CrownDAOLogic is M2MonstersDAOStorageV1, M2MonstersDAOEvents {
    ...
    function state(uint256 proposalId) public view returns (ProposalState) {
        ...
        } else if (proposal.forVotes <= proposal.againstVotes || (proposal.forVotes + proposal.againstVotes) < proposal.quorumVotes || proposal.forVotes < bps2Uint(proposal.proposalThreshold, (proposal.forVotes + proposal.againstVotes))) {
