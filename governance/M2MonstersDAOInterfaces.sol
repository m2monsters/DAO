...
contract M2MonstersDAOEvents {
    ...
    event VoteCast(uint256[] indexed voter, uint256 proposalId, uint8 support, uint256 votes, string reason);
...
interface M2MonstersTokenLike {
    ...
    function MonsterCategory(uint _id) external view returns (uint256);
